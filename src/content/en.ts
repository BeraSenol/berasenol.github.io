...
export const en: Content = {
  lang: 'en',
  alternate: { lang: 'nl', href: '/nl/', label: 'NL', title: 'Bekijk deze pagina in het Nederlands' },
  meta: {
  ...
  dgt: {
    ...
    boardLabel: 'A chessboard playing Fool\u2019s Mate, the shortest checkmate there is: 1.f3 e5 2.g4 Qh4 mate',
    boardCaption: 'Fool\u2019s Mate. Four half-moves, and it is over.',
  },
  education: [
    { title: 'Applied Computer Science', org: 'PXL Hasselt', period: '2017 – 2022' },
  ...
  languages: {
    natural: ['Dutch*', 'English', 'Turkish', 'French', 'German', 'Japanese', 'Italian'],
    programming: ['JavaScript', 'Swift', 'Java*', 'SQL', 'C#', 'Python', 'C++'],
  },
  contactLinks: [
    { label: 'Email', value: 'berasenol@icloud.com', href: 'mailto:berasenol@icloud.com' },
    { label: 'GitHub', value: 'github.com/BeraSenol', href: 'https://github.com/BeraSenol' },
    { label: 'Based in', value: 'Hasselt, Belgium' },
  ],
