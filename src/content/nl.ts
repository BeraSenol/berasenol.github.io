...
export const nl: Content = {
  lang: 'nl',
  alternate: { lang: 'en', href: '/en/', label: 'EN', title: 'View this page in English' },
  meta: {
  ...
  kitchen: {
    ...
    exteriorAlt: 'De straatgevel van Entrepot del Tartufo, met gedekte tafels op het terras',
  ...
  dgt: {
    ...
    boardLabel: 'Een schaakbord dat het narrenmat speelt, het kortste schaakmat dat bestaat: 1.f3 e5 2.g4 Dh4 mat',
    boardCaption: 'Narrenmat. Vier halve zetten en het is voorbij.',
  },
  education: [
    { title: 'Toegepaste Informatica', org: 'PXL Hasselt', period: '2017 – 2022' },
  ...
  languages: {
    natural: ['Nederlands*', 'Engels', 'Turks', 'Frans', 'Duits', 'Japans', 'Italiaans'],
    programming: ['JavaScript', 'Swift', 'Java*', 'SQL', 'C#', 'Python', 'C++'],
  },
  contactLinks: [
    { label: 'E-mail', value: 'berasenol@icloud.com', href: 'mailto:berasenol@icloud.com' },
    { label: 'GitHub', value: 'github.com/BeraSenol', href: 'https://github.com/BeraSenol' },
    { label: 'Gevestigd in', value: 'Hasselt, België' },
  ],
  memojiAlt: 'Memoji van Bera Senol die zwaait',
  nuggets: [
    { icon: 'note', label: 'Verzamelt Drum & Bass alsof het Pokémonkaarten zijn' },
