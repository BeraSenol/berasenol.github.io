...
export function MacOsMark({ className = '' }: { className?: string }) {
  return (
    <svg viewBox="0 0 34 34" className={className} role="img" aria-label="macOS">
      <defs>
        <linearGradient id={MACOS_GRADIENT_ID} x1="0" y1="0" x2="1" y2="0">
...
export function SwiftMark({ className = '' }: { className?: string }) {
  return (
    <svg viewBox="-252 343.9 106.1 106.1" className={className} role="img" aria-label="Swift">
      <path
        fill="#f05138"
...
export function SwiftUiMark({ className = '' }: { className?: string }) {
  return <img src={swiftUiIcon} alt="SwiftUI" width={128} height={128} className={className} />
}

export function SwiftDataMark({ className = '' }: { className?: string }) {
  return <img src={swiftDataIcon} alt="SwiftData" width={128} height={128} className={className} />
}

export function StockfishMark({ className = '' }: { className?: string }) {
  return <img src={stockfishIcon} alt="Stockfish" width={128} height={128} className={className} />
}

export function SwiftTestingMark({ className = '' }: { className?: string }) {
  return (
    <img src={swiftTestingIcon} alt="Swift Testing" width={128} height={128} className={className} />
  )
}

export function XcodeMark({ className = '' }: { className?: string }) {
  return <img src={xcodeIcon} alt="Xcode" width={128} height={128} className={className} />
}
