 ...
 * treatment.
 *
 * useId rather than a fixed id: a gradient is looked up by document id, and
 * two copies of this component with the same id would both paint with
 * whichever <linearGradient> the browser finds first.
 *
 * Decorative by default. Next to the words "Unreal Engine" a labelled mark
 * would make a screen reader say the name twice. Pass `label` where the mark
 * stands on its own.
 *
 * Path from SVG Repo, its viewBox is the artwork's own 32x32 box.
 */
